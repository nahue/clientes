...
class ServiciosControllerTest < ActionController::TestCase
  ...
  test "should create servicio" do
    assert_difference('Servicio.count') do
      post :create, servicio: { alta: @servicio.alta, baja: @servicio.baja, cliente_id: @servicio.cliente_id, password: @servicio.password, user: @servicio.user }
    end
  ...
  test "should update servicio" do
    patch :update, id: @servicio, servicio: { alta: @servicio.alta, baja: @servicio.baja, cliente_id: @servicio.cliente_id, password: @servicio.password, user: @servicio.user }
    assert_redirected_to servicio_path(assigns(:servicio))
  end
